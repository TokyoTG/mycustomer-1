...
@section('custom_css')
<link href="{{ asset('/backend/assets/css/register.css') }}" rel="stylesheet" type="text/css" />
@endsection
@section('content')
<div class="d-flex justify-content-between reg">
        ...
        <div class="">
            <div class="regForm">
                <form action="" id="regForm" class="">
                    ...
                    <div class="formInput">
                        <input type="text" placeholder="Enter Name" name="name" autocomplete="name">
                    </div>
                    <div class="formInput">
                        <input type="email" placeholder="Email Address" name="email" autocomplete="email">
                    </div>
                    <div class="formInput">
                        <input type="tel" placeholder="Phone Number" name="phone" autocomplete="phone">
                    </div>
                    <div class="formInput">
                    ...
                    <button type="submit" class="regFromBtn">Sign Up</button>
                </form>
    ...
    <div class="regImg w-50 position-relative">
        ...
        <div class="hero">
            <h1>Welcome to <span>My</span>Customer</h1>
            <p>Sign up, Let's get you started</p>
        </div>
    </div>
</div>
@endsection
